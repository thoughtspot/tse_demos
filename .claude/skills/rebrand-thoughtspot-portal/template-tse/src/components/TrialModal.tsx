// Professional upgrade prompt shown once (on the 3rd Ask Northwind AI question).
import { X, Sparkles, Check, ArrowRight } from 'lucide-react';
import { Northwind_UPGRADE_URL } from '../config';
    ...
    <div className="sl-trial-overlay" onClick={onClose}>
      <div className="sl-trial-modal" onClick={(e) => e.stopPropagation()} role="dialog" aria-modal="true">
        ...
        <div className="sl-trial-body">
          ...
          <a className="sl-trial-cta" href={Northwind_UPGRADE_URL} target="_blank" rel="noopener noreferrer">
          ...
          <p className="sl-trial-fine">
            Demo experience — no payment is taken. Talk to your Northwind account team for
            production pricing.
          </p>
        </div>
      </div>
